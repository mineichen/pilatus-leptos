    ...
    view! {
        <nav class="flex-1 overflow-y-auto">
            <div class="px-6 pt-4 pb-2">
                <span class="text-xs font-semibold text-muted-foreground uppercase tracking-wider">"Devices"</span>
            </div>
            <div class="px-3 space-y-1">
                <For
                    ...
                    <A
                        ...
                        attr:class="flex items-center gap-3 px-4 py-3 rounded-lg text-foreground hover:text-foreground hover:bg-accent transition-colors"
                    >
